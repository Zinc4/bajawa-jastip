          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex">
                ...
                <span className="text-gray-400">info@bajawajastip.com</span>
              </li>
              <li className="flex">
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-2">
                <a
                  href="#"
                  className="bg-gray-800 hover:bg-gray-700 p-2 rounded flex items-center"
                >
                  <svg
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} Bajawa Jastip. All rights reserved.
            </p>
