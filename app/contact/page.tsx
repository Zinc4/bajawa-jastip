...
export const metadata: Metadata = {
  title: "Hubungi Kami",
  description:
    "Get in touch with Bajawa Jastip. Contact us for inquiries, support, or to request our services.",
};
          ...
          <CardContent>
            <form className="space-y-4">
              ...
              <Button type="submit" className="w-full">
                <a
                  href="https://api.whatsapp.com/send/?phone=6287850544899&text=Hallo+Admin+saya+mau+menggunakan+Jasa+Titip+dari+Bajawa+Jastip."
                  target="_blank"
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    0821-4660-4403 (Admin Timor)
                    <br />
                    0878-5054-4899 (Admin Flores)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    info@bajawajastip.com
                    <br />
                    support@bajawajastip.com
                  </p>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex space-x-4">
                <a
                  href=" https://www.facebook.com/profile.php?id=100088352374645"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* <a
                  href="https://twitter.com/bajawajastip"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.wa.me/6287850544899"
                  target="_blank"
                  rel="noopener noreferrer"
