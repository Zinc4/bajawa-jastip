...
export default function AboutPage() {
  ...
  const timeline = [
    ...
    { year: "2023", event: "Reached milestone of 1 million successful deliveries" },
  ]
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold mb-8 text-center">About Bajawa Jastip</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-6">
                Bajawa Jastip was founded in 2015 with a simple mission: to provide reliable, efficient delivery
                services across Indonesia. What began as a small operation in Jakarta has grown into a nationwide
                network of trusted delivery professionals.
              </p>
              <p className="text-gray-700 mb-6">
                Our name "Bajawa" comes from a beautiful region in Flores known for its community spirit and natural
                beauty - values that we embody in our service approach.
              </p>
              <p className="text-gray-700">
                Today, we serve thousands of customers across Indonesia, from individuals sending gifts to loved ones to
                businesses requiring regular delivery services. Our commitment to quality and reliability remains
                unchanged.
              </p>
            </div>
              ...
              <div className="space-y-4">
                {timeline.map((item, index) => (
                  <div key={index} className="flex items-start">
                    <div className="bg-primary text-white font-bold py-1 px-3 rounded-full mr-4">{item.year}</div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700">
                  To connect people and businesses across Indonesia through reliable, efficient, and personalized
                  delivery services that exceed customer expectations.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700">
                  To be Indonesia's most trusted delivery service, known for our reliability, innovation, and commitment
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="border p-4 rounded-lg text-center">
                ...
                <div className="text-sm text-gray-600">Logistics Certification</div>
              </div>
            </div>
          </div>
        </TabsContent>
