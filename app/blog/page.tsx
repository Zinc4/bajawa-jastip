...
export const metadata: Metadata = {
  title: "Blog",
  description:
    "Read our latest articles on shipping tips, company updates, and success stories.",
};
...
export default function BlogPage() {
  const blogPosts = [
    {
      ...
      date: "April 15, 2023",
      author: "Budi Santoso",
      image: "/blog_1.png?height=400&width=600",
    ...
    },
    {
      ...
      date: "March 22, 2023",
      author: "Adi Wijaya",
      image: "/blog_2.png?height=400&width=600",
      authorImage: "/placeholder.svg?height=100&width=100",
    },
    {
      id: "3",
      ...
      author: "Siti Rahayu",
      image: "/blog_3.png?height=400&width=600",
      authorImage: "/placeholder.svg?height=100&width=100",
    },
    {
      id: "4",
      ...
      author: "Maya Putri",
      image: "/blog_4.png?height=400&width=600",
      authorImage: "/placeholder.svg?height=100&width=100",
    },
    {
      id: "5",
      ...
      author: "Adi Wijaya",
      image: "/blog_5.png?height=400&width=600",
      authorImage: "/placeholder.svg?height=100&width=100",
    },
    // {
    //   id: "6",
  ...
  const categories = [
    ...
    {
      name: "Shipping Tips",
      count: blogPosts.filter((post) => post.category === "Shipping Tips")
        .length,
    },
    {
      name: "Updates",
      count: blogPosts.filter((post) => post.category === "Updates").length,
    },
    {
      name: "Success Stories",
      count: blogPosts.filter((post) => post.category === "Success Stories")
        .length,
    },
  ];
